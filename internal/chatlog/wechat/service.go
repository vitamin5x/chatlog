...
// GetImageKey extracts the image encryption key from a WeChat process
func (s *Service) GetImageKey(info *wechat.Account) (string, string, error) {
	if info == nil {
		return "", "", fmt.Errorf("no WeChat instance selected")
	}
